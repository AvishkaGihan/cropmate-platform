...
const CropsPage = async ({
  ...
  return (
    <div className="container min-h-screen py-8 mx-auto">
      ...
      <div className="rounded-lg bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-950/40 dark:to-emerald-950/40 p-8 mb-8">
            ...
            <form className="flex gap-2">
              <div className="relative flex-1">
                ...
                <Input
                  ...
                  className="pl-8 h-11 border-green-100 dark:border-green-900/30"
                  defaultValue={searchQuery}
                />
              </div>
              <Button
                type="submit"
                className="h-11 px-6 bg-green-600 hover:bg-green-700 cursor-pointer"
              >
                Search
              </Button>
            </form>
